  ...
  let navBar = (
    <React.Fragment>
      <div className="m-header">
        ...
        <Link to="#" className="b-brand" style={{display:"flex", alignItems:"center"}}>
          <img id="main-logo" src={logo} alt="" className="logo" style={{width:"80px",objectFit:"cover"}}/>
          <p style={{marginBottom:"0"}}>DestinyMatch</p>
        </Link>
